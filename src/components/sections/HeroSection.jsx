              ...
              <div className="pt-6 sm:pt-8 border-t border-gray-200/80">
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-left">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <h5 className="text-xs font-bold text-gray-900">{trustBadge1Title}</h5>
                      <p className="text-[10px] text-gray-500">{trustBadge1Sub}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <h5 className="text-xs font-bold text-gray-900">{trustBadge2Title}</h5>
                      <p className="text-[10px] text-gray-500">{trustBadge2Sub}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <h5 className="text-xs font-bold text-gray-900">{trustBadge3Title}</h5>
                      <p className="text-[10px] text-gray-500">{trustBadge3Sub}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <h5 className="text-xs font-bold text-gray-900">{trustBadge4Title}</h5>
                      <p className="text-[10px] text-gray-500">{trustBadge4Sub}</p>
                    </div>
                  </div>
                </div>
              </div>
